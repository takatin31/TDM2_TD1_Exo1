...
import kotlinx.android.synthetic.main.activity_some_other.*
...
import kotlinx.android.synthetic.main.activity_some_other.settingBtn
...
class SomeOtherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        thirdActivityLayout.setBackgroundColor(ContextCompat.getColor(this, color))
